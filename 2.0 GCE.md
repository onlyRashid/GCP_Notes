...
## Full 3 VM create example using gcloud

gcloud compute instances create my-vm my-vm2 my-vm3 \
    --project=rashid-learning-project \
    --zone=us-central1-a \
    --machine-type=e2-standard-4 \
    --image-family ubuntu-minimal-2204-lts \
    --image-project ubuntu-os-cloud

glcoud compute instances delete my-vm my-vm2 my-vm3 --zone=us-central1-a 
